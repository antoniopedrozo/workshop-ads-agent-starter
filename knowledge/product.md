...
> **Como usar este arquivo:** descreva seu produto em uma página. O assistente lê isso antes de gerar copy, sugerir keywords ou pensar em targeting. Quanto mais concreto, melhor.
>
> O exemplo abaixo é da empresa fictícia **AcmeRH**. Substitua tudo pelo seu produto, ou mantenha como referência enquanto escreve o seu.
...
Toda vez que:
- Lançar feature nova relevante (impacta copy de ads de ativação)
- Trocar posicionamento (impacta tudo)
- Adicionar/remover integração nativa (impacta keywords e segmentação)
- Mudar prova social principal (impacta CTR)
